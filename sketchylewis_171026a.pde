...
//Variables go here
 ...
 void setup () {
 size (500,501); //Deals with overlapping lines in design                                                  
//fullScreen();
//print("My display width is ", + displayWidth + "/n My display Height is " + displayHeight);
//draw () {}
//ellipse(displayWidth/2, displayHeight/2, displsayHeight, displayHeight ); //Main face shape
...
ellipse(375,125,75,75); // eye 1
ellipse(125,125,75,75); // eye 2
rectMode(CENTER);
