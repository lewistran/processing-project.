...
ellipse(displayWidth*3/8, displayHeight/3, displayHeight/6, displayHeight/10);// Eye #1                         
ellipse(displayWidth*5/8, displayHeight/3, displayHeight/6, displayHeight/10); // Eye #2
...
rect(displayWidth/2, (displayHeight/2)+(displayHeight/5), displayHeight/4, displayHeight/13);    // mouth
